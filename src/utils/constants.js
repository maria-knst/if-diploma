...
export const BASE_PATH = "https://modnikky-api.herokuapp.com/api/catalog";

export const fake_info =
  "Saints are a low-waist, drop crotch relaxed boyfriend jean.\n" +
  "                  Straight fit across the hips, bow shape legs, with knee darts\n" +
  "                  and tapered leg. Back pockets dropped slightly for slouch\n" +
  "                  feel.";
